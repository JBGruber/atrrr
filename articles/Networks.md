...
interconnected relationships among followers.
...
![Follower Network](figures/unnamed-chunk-6-1.png)
...
Want to create like networks? The `get_likes` function allows you to
extract information about users who liked a specific post. By simply
providing the post’s URL, you can get a list of users who expressed
...
Want to create repost networks? Reposts (or reskeets), akin to retweets
on platforms like Twitter, amplify the reach of content by sharing it
