...
to the original post, creating a thread of conversation. If you don’t
have the URI of a skeet, a link to it will also do.
...
Media can be posted by using a path to a file. They can also be included
in a thread.
