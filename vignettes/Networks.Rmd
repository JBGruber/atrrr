...
```{r, fig.cap="Follower Network", fig.width=8, fig.height=6}
...
ggraph::ggraph(graph, layout = "kk") +
  ...
  ggraph::geom_node_text(aes(label = name, size = tidygraph::centrality_pagerank()), 
                   vjust = 1, hjust = 1, check_overlap = T, color = "blue") +
  ggplot2::theme_void() +
