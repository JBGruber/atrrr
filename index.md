...
The goal of atrrr[¹](#fn1) is to wrap the AT Protocol (Authenticated
Transfer Protocol) behind Bluesky. [*And we have actually already
fulfilled this goal!*](#want-to-help).
...
![RStudio Popup](articles/figures/password_popup.png)

RStudio Popup

The page to generate app passwords is also automatically opened for you.

![page to create new app passwords](articles/figures/app_password.png)
...
is just a thin wrapper around that and calls an optional parsing
function:
